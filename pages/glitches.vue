<template>
  <div>
    ...
    <div class="container">
      ...
      <hr/>
      <main>
        <center><NuxtLink to="oddities">Oddities</NuxtLink> | <NuxtLink to="easter-eggs">Easter Eggs</NuxtLink> | <NuxtLink to="bugs">Bugs</NuxtLink> | <NuxtLink to="glitches">Glitches</NuxtLink></center>
        <p>Aqui estão os glitches (erros de programação ou processameto que passaram despercebidos pelos programadores e que, em alguns casos, podem proporcionar algum benefício ao jogador) catalogados por meu amigo, <b>Jack (O' Bones) Wilker Barros</b>.</p>
        <ol>
          <li><b>Sword Brothers Glitch (SBG):</b><br/>
          <b>Objetivo:</b> Sair do Castelo.<br/>
          <b>Onde usar:</b> Royal Chapel e Anti-Chapel.<br/>
          <b>Requisitos:</b> 30 MP, <Item item="Sword Card"/> (Familiar Sword <abbr title="Level">LV</abbr> 90) e <Item item="Soul of Bat"/>.<br/>
          Esteja usando o 'Familiar Sword' no level 90 ou maior. Vá para Royal Chapel (ou Anti-Chapel) na sala anterior ao confessionário. Faça a magia 'Sword Brothers'. Espere a espada fazer o giro completo e ande para a esquerda. Transforme-se em morcego para não cair e você passará para fora do castelo.</li>
          <li><b>Wolf Glitch (WG):</b><br/>
          ...
          Esteja equipado com um <Item item="Heart Refresh"/> em cada mão e com um <Item item="Duplicator"/>. Deixe Alucard posicionado no final da sala, quase que mudando de tela, pule em direção à próxima sala e, antes de mudar de sala, use o primeiro <Item item="Heart Refresh"/> de uma das mãos. Antes que a animação do <abbr title="Heart Refresh">HR</abbr> acabe, segure o botão correspondente à outra mão para usar o segundo <abbr title="Heart Refresh">HR</abbr> imediatamente após o primeiro e, antes que a animação deste desapareça, segure novamente o botão do primeiro <abbr title="Heart Refresh">HR</abbr>. Faça este procedimento até que Alucard esteja imerso no chão até pela cintura. Se ocorrer tudo bem, Alucard poderá "andar" livremente sob o piso da área.</li>
          <li><b>Edge Travel (ET):</b><br/>
          ...
          <b>Requisitos:</b> <Item item="Heart Refresh"/>.<br/>
          Quando se está fora do castelo, na maioria das vezes, Alucard fica como se estivesse caindo, devido a falta de chão. Use um <abbr title="Heart Refresh">HR</abbr> para ganhar uma sala branca ('Glitch Room') embaixo da área em que você se encontra. Voce também pode adquirir salas laterais. Para isto, basta encostar Alucard no limite máximo da direita ou esquerda, manter o direcional pressionado na direção em que deseja ganhar a 'Glitch Room' e usar um <Item item="Heart Refresh"/>.</li>
          <li><b>Shield Rod Glitch (SRG):</b><br/>
          <b>Objetivo:</b> Abrir uma 'Glitch Room'<br/>
          <b>Onde usar:</b> Fora do castelo<br/>
          <b>Requisitos:</b> <Item item="Shield rod"/> ou <Item item="Mablung Sword"/> e qualquer escudo.<br/>
          É possível adquirir salas brancas usando a magia de um escudo quando se está fora do castelo no limite da tela. Esta técnica é muito limitada, pois ao contrário da <abbr title="Single Heart Refresh">SHR</abbr>, não pode ser usada em todos os lugares.</li>
          <li><b>Dive Kick Double Heart Refresh (DHR):</b><br/>
          ...
          <b>Requisitos:</b> <Item item="Soul of Bat"/>, <Item item="Heart Refresh"/> e <Item item="Duplicator"/>.<br/>
          Para adquirir 'Glitch Room' após ao lado de 'Save Points' ou 'Teleport Pads', quando já estiver fora do castelo, debaixo da sala, faça o seguinte: Esteja equipado com um <Item item="Heart Refresh"/>, transforme-se em morcego, encoste no limite máximo da tela (direita ou esquerda) e execute um 'Wing Smash'. Durante a magia, mantenha o direcional pressionado para cima. Após o término do movimento, Alucard será jogado para a borda lateral da sala, então, segure para frente (no sentido da borda) e use um <Item item="Heart Refresh"/> rapidamente, antes que Alucard caia.</li>
          <li><b>Meat Alucard:</b><br/>
          Equipe-se com 2 <Item item="Fire boomerang"/> e atire rapidamente 6 deles (o máximo possível). Antes que o primeiro <Item item="Fire boomerang"/> fuja da tela, transforme-se no lobo.<br/>
          ...
          c) Se dormir quando estiver junto com a transformação, não ouvirá o ronco de Alucard.<br/>
          d) Se usar o <Item item="Talisman"/>, você não verá o reflexo dele, mas ele funcionará.<br/>
          e) Alucard perde seu reflexo natural.<br/>
          f) A magia do <Item item="AxeLord shield"/> só sai uma por vez.<br/>
          g) Quando usa o 'Save Orb', a metamorfose ficará na frente do caixão.<br/>
          h) Se a fada lhe ressussitar, o efeito se desfaz.<br/>
          Variações com a névoa:<br/>
          a) Se levar uma pancada, o efeito se desfaz.<br/>
          b) Se fizer 'Hellfire', o efeito não se desfaz.<br/>
          c) Se atacar com armas tipo Rod, Sword ou Escudo o efeito se desfaz.<br/>
          d) Ande o mais rápido e mais distante que puder para que a névoa fique enorme. Para isso, execute 'Dive Kicks'.</li>
        </ol>
      </main>
      <hr/>
      <Footer/>
